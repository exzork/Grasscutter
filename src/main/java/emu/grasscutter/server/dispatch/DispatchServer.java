...
public final class DispatchServer {
    ...
    public void start() throws Exception {
        ...
        for (
                String regionName : regions.keySet()) {
        ...
        server.createContext( // hk4e-api-os.hoyoverse.com
                ...
                new
                        ...
                        DispatchHttpJsonHandler("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"total\":0,\"list\":[]}}"));
        server.createContext( // hk4e-api-os.hoyoverse.com
        ...
        server.createContext( // hk4e-api-os-static.hoyoverse.com
                ...
                new
                        ...
                        DispatchHttpJsonHandler("{\"retcode\":0,\"message\":\"OK\",\"data\":{\"list\":[],\"total\":0}}"));
        server.createContext( // hk4e-sdk-os.hoyoverse.com
        ...
        server.createContext( // log-upload-os.mihoyo.com
                ...
                new
                        ...
                        DispatchHttpJsonHandler("{\"code\":0}"));
        server.createContext( // log-upload-os.mihoyo.com
                "/sdk/upload",
                new
        ...
        Grasscutter.getLogger().
                ...
                info("[Dispatch] Dispatch server started on port " + getAddress().
